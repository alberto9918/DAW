...
/**
 * Servlet implementation class Controlador_BuscarUsuarioActualizar
 */
@WebServlet("/Controlador_BuscarUsuarioActualizar")
public class Controlador_BuscarUsuarioActualizar extends HttpServlet {
     ...
     */
    public Controlador_BuscarUsuarioActualizar() {
        super();
